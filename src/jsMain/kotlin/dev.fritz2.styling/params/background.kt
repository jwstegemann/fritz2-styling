...
/**
 * Predefined values for the [background-repeat](https://developer.mozilla.org/de/docs/Web/CSS/background-repeat)
...
/**
 * Predefined values for the [background-blend-mode](https://developer.mozilla.org/de/docs/Web/CSS/background-blend-mode)
...
/**
 * Predefined values for the [background-position](https://developer.mozilla.org/de/docs/Web/CSS/background-position)
 ...
 * for the [background-position](https://developer.mozilla.org/de/docs/Web/CSS/background-position) property.
 *
...
/**
 * Predefined values for the [background-size](https://developer.mozilla.org/de/docs/Web/CSS/background-size)
 ...
 * for the [background-size](https://developer.mozilla.org/de/docs/Web/CSS/background-size) property.
 *
...
/**
 * Predefined values for the [background-origin](https://developer.mozilla.org/de/docs/Web/CSS/background-origin)
 * and [background-clip](https://developer.mozilla.org/de/docs/Web/CSS/background-clip) properties.
...
/**
 * Predefined values for the [background-attachment](https://developer.mozilla.org/de/docs/Web/CSS/background-attachment)
...
class BackgroundContext(
    ...
    /**
     * This function is used to set the [background-blend-mode](https://developer.mozilla.org/de/docs/Web/CSS/background-blend-mode)
     ...
     * [background-image](https://developer.mozilla.org/de/docs/Web/CSS/background-image) property.
     *
     * Example call
     * ```
     * background {
     ...
     * [background-image](https://developer.mozilla.org/de/docs/Web/CSS/background-image) property to ``none``.
     *
    ...
    /**
     * This function is used to set the [background-position](https://developer.mozilla.org/de/docs/Web/CSS/background-position)
    ...
    /**
     * This function is used to set the [background-size](https://developer.mozilla.org/de/docs/Web/CSS/background-size)
    ...
    /**
     * This function is used to set the [background-repeat](https://developer.mozilla.org/de/docs/Web/CSS/background-repeat)
    ...
    /**
     * This function is used to set the [background-origin](https://developer.mozilla.org/de/docs/Web/CSS/background-origin)
    ...
    /**
     * This function is used to set the [background-clip](https://developer.mozilla.org/de/docs/Web/CSS/background-clip)
     * property. Predefined values are offered by [BackgroundBoxValues].
     *
     * Example call
     * ```
    ...
    /**
     * This function is used to set the [background-attachment](https://developer.mozilla.org/de/docs/Web/CSS/background-attachment)
     ...
     * [background-color](https://developer.mozilla.org/de/docs/Web/CSS/background-color) property.
     *
     * Example call
     * ```
     * background {
