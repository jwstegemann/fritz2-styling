...
/**
 * Predefined values for the [grid-auto-flow](https://developer.mozilla.org/de/docs/Web/CSS/grid-auto-flow)
...
class GridTemplateContext(
    ...
    /**
     * Predefined value for the [minmax()](https://developer.mozilla.org/de/docs/Web/CSS/repeat) related CSS value
     */
    ...
    /**
     * Predefined value for the [minmax()](https://developer.mozilla.org/de/docs/Web/CSS/repeat) related CSS value and
     * predefined value for the [minmax()](https://developer.mozilla.org/de/docs/Web/CSS/minmax) related CSS value
     */
    ...
    /**
     * Function to create the CSS [repeat](https://developer.mozilla.org/de/docs/Web/CSS/repeat) function.
     *
    ...
    /**
     * Function to create the CSS [minmax](https://developer.mozilla.org/de/docs/Web/CSS/minmax) function.
     *
 ...
 * with the [display](https://developer.mozilla.org/de/docs/Web/CSS/display) property already set to ``grid``.
 *
...
interface GridLayout : StyleParams, Alignment {
     ...
     * [grid-template-columns](https://developer.mozilla.org/de/docs/Web/CSS/grid-template-columns) CSS property
     ...
     * [grid-template-rows](https://developer.mozilla.org/de/docs/Web/CSS/grid-template-rows) CSS property
     * for all media devices.
     *
     * The actual definition is then done within the [GridTemplateContext] using the specific topic functions of it.
     *
     ...
     * [grid-auto-rows](https://developer.mozilla.org/de/docs/Web/CSS/grid-auto-rows) CSS property
     * for all media devices.
     *
     * The actual definition is then done within the [GridTemplateContext] using the specific topic functions of it.
     *
     ...
     * [grid-auto-columns](https://developer.mozilla.org/de/docs/Web/CSS/grid-auto-columns) CSS property
     * for all media devices.
     *
     * The actual definition is then done within the [GridTemplateContext] using the specific topic functions of it.
     *
    ...
    /**
     * This function sets the [grid-auto-flow](https://developer.mozilla.org/de/docs/Web/CSS/grid-auto-flow) property
     * for all media devices.
     *
     ...
     * [grid-template-areas](https://developer.mozilla.org/de/docs/Web/CSS/grid-template-areas) CSS property
     * for all media devices.
     *
     ...
     * - [row-gap](https://developer.mozilla.org/de/docs/Web/CSS/row-gap)
     * - [column-gap](https://developer.mozilla.org/de/docs/Web/CSS/column-gap)
     *
     * It is recommended to use the predefined properties from the [theme][dev.fritz2.styling.Theme.gridGap].
     *
     * Example call:
    ...
    /**
     * Function to create the CSS [fit-content](https://developer.mozilla.org/de/docs/Web/CSS/fit-content) function.
     */
